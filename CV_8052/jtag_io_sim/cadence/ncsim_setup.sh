...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_soft_core_jtag_io/altera_soft_core_jtag_io.vhd" -work jtag_io -cdslib ./cds_libs/jtag_io.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/jtag_io.vhd"                                                                                           
fi
