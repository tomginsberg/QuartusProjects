...
# # End of template
# ----------------------------------------
# If jtag_io is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.0 150 win32 2015.07.06.10:25:33
...
ensure_lib         ./libraries/jtag_io/
vmap       jtag_io ./libraries/jtag_io/
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_soft_core_jtag_io/altera_soft_core_jtag_io.vhd" -work jtag_io
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/jtag_io.vhd"                                                        
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L jtag_io -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L jtag_io -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
